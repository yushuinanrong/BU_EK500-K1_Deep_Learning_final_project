...
#x = tf.divide(x, 255.0)
# corrupted image
x_small   = tf.image.resize_bicubic(x, (H/2, W/2))
x_nearest = tf.image.resize_images(x_small, (H, W), tf.image.ResizeMethod.NEAREST_NEIGHBOR)
...
print "gen shape is:" + str(gen.get_shape().as_list())
#
# input image pairs
#
...
alt_train(log_interval=10, max_ep=20, ep_size=data.train.num_batch, early_stop=False,
          save_dir='asset/train/GAN_SR/model_cifar10')
